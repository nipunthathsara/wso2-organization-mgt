...
public class OrganizationMgtEndpointUtil {
    ...
    public static OrganizationAdd getOrganizationAddFromDTO(OrganizationAddDTO organizationAddDTO) {
        ...
        organizationAdd.setRdn(organizationAddDTO.getRdn());
        organizationAdd.setStatus(organizationAddDTO.getStatus());
    ...
    public static OrganizationDTO getOrganizationDTOFromModel(Organization organization) {
        ...
        organizationDTO.setRdn(organization.getRdn());
