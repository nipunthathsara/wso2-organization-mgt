...
public class OrganizationUserRoleMapping {
    ...
    public OrganizationUserRoleMapping(String organizationId, String userId, String roleId, int hybridRoleId, boolean cascadedRole, String assignedOrganizationLevel) {
