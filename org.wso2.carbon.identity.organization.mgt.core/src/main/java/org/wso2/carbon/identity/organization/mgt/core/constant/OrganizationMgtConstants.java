...
public class OrganizationMgtConstants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_CODE_QUERY_LENGTH_EXCEEDED_ERROR("ORGMGT_00005", "SQL query length too large."),
        ERROR_CODE_INVALID_ORGANIZATION_ID_ERROR("ORGMGT_00006", "Invalid organization ID : %s."),
