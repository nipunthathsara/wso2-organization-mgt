...
CREATE TABLE UM_USER_ROLE_ORG (
    ...
    PRIMARY KEY (UM_ID),
    CONSTRAINT UM_USER_ROLE_ORG_CONSTRAINT UNIQUE(UM_USER_ID, UM_HYBRID_ROLE_ID, UM_TENANT_ID, ORG_ID, ASSIGNED_AT),
    ...
    CONSTRAINT FK_UM_USER_ROLE_ORG_ASSIGNED_AT FOREIGN KEY (ASSIGNED_AT) REFERENCES UM_ORG(ID) ON DELETE CASCADE
)
/
