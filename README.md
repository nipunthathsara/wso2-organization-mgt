...
CREATE TABLE UM_USER_ROLE_ORG (
    ...
    ORG_ID VARCHAR2(255) NOT NULL,
    PRIMARY KEY (UM_ID),
    CONSTRAINT UM_USER_ROLE_ORG_CONSTRAINT UNIQUE(UM_USER_ID, UM_ROLE_ID, UM_TENANT_ID, ORG_ID),
    CONSTRAINT FK_UM_USER_ROLE_ORG_UM_HYBRID_ROLE FOREIGN KEY (UM_ROLE_ID, UM_TENANT_ID) REFERENCES UM_HYBRID_ROLE(UM_ID, UM_TENANT_ID) ON DELETE CASCADE,
