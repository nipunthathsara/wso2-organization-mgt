...
public class OrganizationUserRoleMgtConstants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_CODE_ADD_NONE_INTERNAL_ERROR("ORGPERMMGT_00001", "Only internal roles are allowed. Role : %s is not an internal role."),
        ...
        ERROR_CODE_ORGANIZATION_USER_ROLE_MAPPINGS_RETRIEVING_ERROR("ORGPERMMGT_00022", "Error while retrieving the role : %s, for user : %s for organization : %s"),
        ERROR_CODE_HYBRID_ROLE_ID_RETRIEVING_ERROR("ORGPERMMGT_00023", "Error while retrieving the hybrid role id for role : %s"),
        ERROR_CODE_INVALID_ROLE_ERROR("ORGPERMMGT_00024", "Invalid role name: %s"),
        ERROR_CODE_USERS_PER_ORG_ROLE_RETRIEVING_ERROR("ORGPERMMGT_00025", "Error while retrieving users for role: %s , organization : $s");
